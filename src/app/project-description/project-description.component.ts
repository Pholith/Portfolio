...
Il a été réalisé en binôme avec le language Java. Ce projet m'a permis d'étendre mes connaissances en poo et à bien répartir les tâches.",
    ...
    },
    {
      ...
      description: this.asLink("Ce site web", "http://vincent1.heliohost.org/Champs/Site-Chateau-Champs-sur-Marne/html/fr/main.php") +" est mon premier projet tutoré, il s'est déroulé sur toute l'année scolaire 2018-2019 en équipe de 3. \
L'objectif de ce projet est de promouvoir la culture locale et d'attirer de nouveaux visiteurs. Il nous a permis de développer nos compétences en programmation web, communication, anglais et gestion de projet.",
...
La difficulté de ce projet est qu'il nous a été donné à faire en seulement 1 mois et 15 jours ont été requis rien que pour préparer son développement...",
...
dans la réalisation de leur nouvelle application de gestion des DMP (Dossier médical partagé) dans le cadre de notre cours de méthodologie et gestion de projet (2019-2020). \
<br/>Ce projet n'a pas été une simulation dans le sens où il nous a donné énormément de travail et a été très formateur. J'ai appris grâce à ce projet comment fonctionne le travail en équipe de 6. \
Le site a été réalisé avec Vuejs ainsi que JavaEE avec des api REST.",
    ...
    },
    {
      ...
      description: this.asLink("Ce petit projet", "http://vincent1.heliohost.org/Finder/") +" est un site dynamique qui utilise les api du gouvernement français pour permettre de rechercher des formations et établissements scolaires. \
Il a été réalisé dans le cadre d'un cours de développement web (début 2020).",
